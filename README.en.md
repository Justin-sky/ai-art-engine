<div align="center">
  ...
  <p>
    ...
    OpenRouter · OpenAI · DeepSeek · Zhipu · Volcengine Ark · Kling · MiniMax · Tongyi Qianwen · ModelScope<br />
...
- **Model providers** — OpenRouter, OpenAI (GPT text / gpt-image), DeepSeek (text), Zhipu (GLM text / CogView image), Volcengine Ark (Seedream / Seedance / voice), Kling, MiniMax, Tongyi Qianwen (DashScope), ModelScope  
