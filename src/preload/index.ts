...
const api: StudioApi = {
  ...
  evaluateBlenderDshJob: (input) => ipcRenderer.invoke(IpcChannels.BLENDER_DSH_EVALUATE, input),
  ...
  prepareGamePlayDshJob: (input) => ipcRenderer.invoke(IpcChannels.GAMEPLAY_DSH_PREPARE, input),
  seedGamePlayProject: (input) => ipcRenderer.invoke(IpcChannels.GAMEPLAY_DSH_SEED, input),
  validateGamePlayDshJob: (input) => ipcRenderer.invoke(IpcChannels.GAMEPLAY_DSH_VALIDATE, input),
  buildGamePlayProject: (input) => ipcRenderer.invoke(IpcChannels.GAMEPLAY_DSH_BUILD, input),
  prepareBlockoutDshJob: (input) => ipcRenderer.invoke(IpcChannels.BLOCKOUT_DSH_PREPARE, input),
  validateBlockoutDshJob: (input) => ipcRenderer.invoke(IpcChannels.BLOCKOUT_DSH_VALIDATE, input),
  ...
  prewarmHarness: () => ipcRenderer.invoke(IpcChannels.HARNESS_PREWARM),
