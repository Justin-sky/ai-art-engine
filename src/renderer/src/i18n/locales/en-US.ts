...
export default {
  ...
  stage2d: {
    ...
    rigFromImage: '🤸 Pose from image',
    rigFromImageTip: 'Pick a human photo and reverse-solve its pose keypoints into plane rotations for this rig',
    ...
    poseDialogTitle: 'Reverse-solve starting pose',
    poseDialogSubtitle: 'YOLO single-person pose → current rig (plane-only; joints must be named chest/shoulder/elbow/hip/knee… to drive)',
    poseSearch: 'Search image assets…',
    poseNoImages: 'No image assets yet — import a human photo first',
    posePickFirst: 'Pick a human photo on the left; detection runs automatically',
    poseModel: 'Pose model',
    poseFlip: 'Mirror reference (selfie/mirrored source)',
    poseDriveTorso: 'Drive torso',
    poseDetect: 'Detect people',
    poseDetecting: 'Detecting…',
    poseNoPerson: 'No complete person skeleton found',
    posePeopleFound: '{count} person(s) detected — click a skeleton to track it',
    posePerson: 'Person',
    ...
    poseSolveEmptyHint: 'Detected skeletons map onto the rig automatically — green chips below are matched drive segments',
    poseSolveEmpty: 'Nothing solved (matched {ok}/{total} segments)',
    poseApplied: 'Pose applied (matched {ok}/{total} segments)',
    poseApply: 'Apply & close',
    poseCancel: 'Cancel',
    poseFooterHint: 'Low-confidence keypoints are never driven; see chips below for matched segments',
    segOk: 'matched',
    segNoJoint: 'no such joint in rig',
    segNoTip: 'limb lacks its tip joint',
    segNoKp: 'keypoint missing / low confidence',
    segDeg: 'keypoints collapsed to a point',
    segTorso: 'Torso',
    segUpperarm: 'Upper arm',
    segForearm: 'Forearm',
    segThigh: 'Thigh',
    segShin: 'Shin',
    sideL: 'L',
