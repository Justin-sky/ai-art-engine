      ...
      <section class="event-pane">
        <div class="event-toolbar">
          ...
          <div
            class="level-filters"
            role="group"
            :aria-label="t('graph.logs.filterLevel')"
          >
            <button
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  class="event-node"
                  :title="event.nodeTitle || event.nodeId || ''"
                >
            ...
            <div class="detail-pane">
              ...
              <template v-else>
                ...
                <template v-if="selectedApiCalls.length">
                  ...
                  >
                    <div class="api-head">
                      ...
                      >{{ call.skillId }}</span>
                      <span
                        v-if="call.promptHash"
                        class="muted"
                      >{{ call.promptHash }}</span>
                      <span
                ...
                <p
                  v-else-if="!selectedEventHasPorts"
                  class="muted detail-empty"
                >
