<template>
  <div class="oss-panel">
    <p class="hint">
      {{ t('settings.objectStorage.hint') }}
    </p>
    <p class="meta">
      {{ t('settings.objectStorage.singleEnabledHint') }}
    </p>
    ...
    >
      ...
      >
        ...
        <template v-if="provider.providerKind === 'volcengine-tos'">
          <p class="meta">
            {{ t('settings.objectStorage.tos.intro') }}
          </p>
          ...
          <label>
            ...
            >
              <option
                v-for="preset in tosRegionPresets"
                :key="preset.region"
                :value="preset.region"
              >
        ...
        <template v-else-if="provider.providerKind === 'aliyun-oss'">
          <p class="meta">
            {{ t('settings.objectStorage.oss.intro') }}
          </p>
          ...
          <label>
            ...
            >
              <option
                v-for="preset in ossRegionPresets"
                :key="preset.region"
                :value="preset.region"
              >
                {{ preset.label }} ({{ preset.region }})
        ...
        <template v-else-if="provider.providerKind === 'tencent-cos'">
          <p class="meta">
            {{ t('settings.objectStorage.cos.intro') }}
          </p>
          ...
          <label>
            ...
            >
              <option
                v-for="preset in cosRegionPresets"
                :key="preset.region"
                :value="preset.region"
              >
                {{ preset.label }} ({{ preset.region }})
