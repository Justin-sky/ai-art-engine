...
5. params 用节点声明的键：公共生成参数为 text, generateInstruction, generateSystemPrompt, generateAspectRatio, generateResolution, generateQuality, generateDuration, generateCount, generateSeed, generateSeedUseGlobal, generateFrameMode, generateAudio, notes, label, inputDataType；节点私有参数（如 anim.2d 的 animRows / animCols / animGifFps）按 typeId 语义填写。编造的键会被忽略。
